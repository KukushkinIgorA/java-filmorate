...
public class UserControllerTest {
    ...
    public void mustThrowExceptionIfAddUserLoginHaveSpace() {
        ...
        assertEquals("логин не может быть пустым и содержать пробелы: Not Valid Test Login", exception.getMessage());
    ...
    public void mustThrowExceptionIfUpdateUserIdNotFound() {
        ...
        assertEquals("на сервере отстутствует пользователь c id = 999", exception.getMessage());
    ...
    public void mustThrowExceptionIfAddFriendNotFound() {
        ...
        assertEquals("на сервере отстутствует пользователь c id = 2", exception.getMessage());
    }
